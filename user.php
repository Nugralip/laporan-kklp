                      ...
                      <?php $no = 1;
                        ...
                        while ($data = mysqli_fetch_array($row)) : ?>
                          <tr >
                            ...
                            <td><?= $data["username"]; ?></td>
                            <td>
                              <a href="edit.php?pesan=admin&&id=<?= $data['id_admin']; ?>" class="btn btn-info mb-1"><i class="mdi mdi-border-color"></i></a>
                              <a href="user.php?pesan=hapus&&id=<?= $data['id_admin'];?>" onclick="return confirm('yakin ingin hapus data?')" class="btn btn-danger mb-1"><i class="mdi mdi-beaker"></i></a>
                            </td>
                          </tr>
                          <?php $no++; ?>
                        <?php endwhile; ?>
