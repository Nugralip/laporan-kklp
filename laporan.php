                ...
                <div class="row" style="background-color:white;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td align="right">
                              <a href="lprn-ver.php" class="btn btn-white">Laporan Masuk >></a>
                            </td>
                    ...
                    <tbody>
                      <?php 
                          $no=1;
                          $laporan = mysqli_query($koneksi,"SELECT * FROM lprn INNER JOIN mahasiswa ON lprn.id_mahasiswa = mahasiswa.id_mahasiswa WHERE lprn.status = 'konfirm' ");
