                  ...
                  <div class="row">
                    <div class="col-xl-3 col-sm-6">
                      <div class="card card-default card-mini">
                        ...
                        $data_pesan = mysqli_query($koneksi,"SELECT * FROM lprn");
                        
                        // menghitung data barang
                        $jumlah_pesan = mysqli_num_rows($data_pesan);
                        ?>
                          <h2><?= $jumlah_pesan." Laporan"?></h2>
                          <div class="sub-title">
                    ...
                    <div class="col-xl-3 col-sm-6">
                      <div class="card card-default card-mini">
                        ...
                        // mengambil data barang
                        $data_rute = mysqli_query($koneksi,"SELECT * FROM mahasiswa");
                        
                        // menghitung data barang
                        $jumlah_rute = mysqli_num_rows($data_rute);
                        ?>
                          <h2><?= $jumlah_rute." Mahasiswa"?></h2>
                          <div class="sub-title">
                    ...
                    <div class="col-xl-3 col-sm-6">
                      <div class="card card-default card-mini">
                        ...
                        // mengambil data barang
                        $data_kelas = mysqli_query($koneksi,"SELECT * FROM jurusan");
                        
                        // menghitung data barang
                        $jumlah_kelas = mysqli_num_rows($data_kelas);
                        ?>
                          <h2><?= $jumlah_kelas." Jurusan"?></h2>
                          <div class="sub-title">
